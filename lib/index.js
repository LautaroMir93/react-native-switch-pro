...
export default class extends Component {
  static propTypes = {
    ...
    circleBorderColorActive: ColorPropType,
    circleBorderColorInactive: ColorPropType,
  ...
  static defaultProps = {
    ...
    circleBorderColorActive: 'white',
    circleBorderColorInactive: 'white',
  ...
  render() {
    ...
    const {
      ...
      circleStyle, circleBorderColorActive, circleBorderColorInactive,
      ...rest
    } = this.props
    ...
    const interpolatedCircleBorderColor = switchAnimation.interpolate({
      inputRange: value ? [-this.offset, -1]: [1, this.offset],
      outputRange: [circleBorderColorInactive, circleBorderColorActive],
      extrapolate: 'clamp'
    })
